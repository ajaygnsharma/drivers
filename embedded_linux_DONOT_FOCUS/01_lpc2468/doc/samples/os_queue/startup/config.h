...
// ///////////////////////////////////////////////////////////////
// Clock settings for LPC23xx and LPC24xx family
// ///////////////////////////////////////////////////////////////
...
// ///////////////////////////////////////////////////////////////
// Clock settings for LPC21xx and LPC22xx family
// ///////////////////////////////////////////////////////////////
#else

#if defined (LPC2148) || defined (LPC2129)
...
#if USE_PLL == 1
#define Fcclk (FOSC * PLL_MUL)
#else
#define Fcclk (FOSC)
#endif

#define Fpclk	(Fcclk / PBSD)
...
#if defined (LPC2148) || defined (LPC2129) || defined(LPC2468)
#define CONSOL_BITRATE       38400
#else
#define CONSOL_BITRATE       115200
#endif
#define USE_UART_FIFO         TRUE
...
#elif defined (LPC2364)
#define SRAM_SIZE  (8 * 1024)   /* LPC2368 */
#elif defined (LPC2366)
#define SRAM_SIZE  (32 * 1024)   /* LPC2368 */
#elif defined (LPC2368)
#define SRAM_SIZE  (32 * 1024)   /* LPC2368 */
#elif defined (LPC2378)
#define SRAM_SIZE  (32 * 1024)   /* LPC2378 */
#elif defined (LPC2388)
#define SRAM_SIZE  (64 * 1024)   /* LPC2388 */
