...
#include "lpc246x.h"                            /* LPC23xx and LPC24xx  definitions */
#else
#include "lpc2xxx.h"                            /*  LPC21xx and LPC22xx definitions */
#endif
#include <string.h>
#include <stdlib.h>
#include "config.h"
